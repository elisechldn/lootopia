...
async function main() {
  // ── Users ──────────────────────────────────────────────────────────────────
  const hash = '$2b$10$kfG7lYzqx1jFZpfnR4rBX.3bZDX10SsNoVRNFrkmJU3vDRx//me7i'; // lol
  ...
  await prisma.step.createMany({
    ...
    data: [
      // Paris
      {
        ...
        clue: 'Trouvez le symbole de fer forgé.',
        latitude: 48.8584,
        longitude: 2.2945,
        radius: 200,
        actionType: 'GPS',
      ...
      },
      {
        orderNumber: 2,
        title: 'Le Louvre',
        clue: 'Scannez la pyramide de verre.',
        latitude: 48.8606,
        longitude: 2.3376,
        radius: 100,
        actionType: 'QR_CODE',
      ...
      },
      {
        orderNumber: 3,
        title: 'Notre-Dame',
        clue: 'Un marqueur AR vous attend sur le parvis.',
        latitude: 48.853,
        longitude: 2.3499,
        radius: 50,
        actionType: 'AR',
        points: 200,
        refHunt: huntParis.id,
        arMarker: 'https://assets.example.com/markers/notre-dame.png',
      },
      {
        orderNumber: 4,
        title: 'Sacré-Cœur',
        clue: "Résolvez l'énigme des 99 marches.",
        latitude: 48.8867,
        longitude: 2.3431,
        radius: 30,
        actionType: 'RIDDLE',
      ...
      // Lyon
      {
        orderNumber: 1,
        title: 'Vieux-Lyon',
        clue: 'Entrez dans la première traboule.',
        latitude: 45.76,
        longitude: 4.827,
        radius: 30,
        actionType: 'QR_CODE',
      ...
      },
      {
        ...
        clue: 'Trouvez la mosaïque dorée.',
        latitude: 45.7623,
        longitude: 4.822,
        radius: 50,
        actionType: 'AR',
        points: 180,
        refHunt: huntLyon.id,
        arMarker: 'https://assets.example.com/markers/fourviere.png',
      },
      {
        orderNumber: 3,
        title: 'Place Bellecour',
        clue: 'Scannez la statue équestre.',
        latitude: 45.7578,
        longitude: 4.832,
        radius: 80,
        actionType: 'QR_CODE',
      ...
      // Bordeaux
      {
        ...
        clue: "Photographiez votre reflet dans le miroir d'eau.",
        latitude: 44.8412,
        longitude: -0.5697,
        radius: 100,
        actionType: 'GPS',
      ...
      // Strasbourg
      {
        ...
        clue: "Trouvez l'horloge astronomique.",
        latitude: 48.5818,
        longitude: 7.7507,
        radius: 60,
        actionType: 'AR',
        ...
        arMarker: 'https://assets.example.com/markers/strasbourg.png',
      },
      {
        orderNumber: 2,
        title: 'Petite France',
        clue: 'Scannez le pont couvert.',
        latitude: 48.579,
        longitude: 7.7385,
        radius: 40,
        actionType: 'QR_CODE',
      ...
      // Marseille
      {
        orderNumber: 1,
        title: 'Vieux-Port',
        clue: 'Repérez le bateau à fond bleu.',
        latitude: 43.2951,
        longitude: 5.3745,
        radius: 150,
        actionType: 'GPS',
      ...
      },
      {
        ...
        clue: "Résolvez l'énigme géologique.",
        latitude: 43.2141,
        longitude: 5.4264,
        radius: 80,
        actionType: 'RIDDLE',
      ...
      },
      {
        ...
        clue: 'Trouvez la Bonne Mère en AR.',
        latitude: 43.2845,
        longitude: 5.3708,
        radius: 60,
        actionType: 'AR',
        points: 180,
        refHunt: huntMarseille.id,
        arMarker: 'https://assets.example.com/markers/bonne-mere.png',
      },
      ...
      },
      {
        orderNumber: 2,
        title: 'Abbaye',
        clue: 'Trouvez la salle des chevaliers en AR.',
        latitude: 48.6361,
        longitude: -1.5107,
        radius: 25,
        actionType: 'AR',
        points: 250,
        refHunt: huntMSM.id,
        arMarker: 'https://assets.example.com/markers/abbaye.png',
      },
      {
        orderNumber: 3,
        title: 'Remparts',
        clue: "Résolvez l'énigme des marées.",
        latitude: 48.6359,
        longitude: -1.512,
        radius: 40,
        actionType: 'RIDDLE',
      ...
      // Toulouse
      {
        orderNumber: 1,
        title: 'Capitole',
        clue: 'Trouvez la croix occitane cachée.',
        latitude: 43.6047,
        longitude: 1.4442,
        radius: 60,
        actionType: 'GPS',
      ...
      // Nice
      {
        ...
        clue: 'Trouvez la chaise bleue numéro 47.',
        latitude: 43.695,
        longitude: 7.265,
        radius: 100,
        actionType: 'GPS',
      ...
      },
      {
        orderNumber: 2,
        title: 'Vieux-Nice',
        clue: "Scannez le trompe-l'œil du cours Saleya.",
        latitude: 43.6963,
        longitude: 7.2769,
        radius: 50,
        actionType: 'QR_CODE',
      ...
      },
      {
        orderNumber: 3,
        title: 'Castle Hill',
        clue: "Résolvez l'énigme de la cascade.",
        latitude: 43.6969,
        longitude: 7.2821,
        radius: 70,
        actionType: 'RIDDLE',
      ...
      // Versailles
      {
        ...
        clue: 'Trouvez le reflet du roi en AR.',
        latitude: 48.8048,
        longitude: 2.1203,
        radius: 30,
        actionType: 'AR',
        ...
        arMarker: 'https://assets.example.com/markers/versailles.png',
      },
      {
        orderNumber: 2,
        title: 'Jardins de Versailles',
        clue: 'Scannez la fontaine de Latone.',
        latitude: 48.804,
        longitude: 2.114,
        radius: 60,
        actionType: 'QR_CODE',
      ...
      },
      {
        orderNumber: 3,
        title: 'Grand Trianon',
        clue: "Résolvez l'énigme des appartements roses.",
        latitude: 48.809,
        longitude: 2.104,
        radius: 50,
        actionType: 'RIDDLE',
      ...
      // Nantes
      {
        orderNumber: 1,
        title: "L'Éléphant",
        clue: 'Montez sur le grand éléphant mécanique.',
        latitude: 47.2082,
        longitude: -1.5649,
        radius: 80,
        actionType: 'GPS',
      ...
      },
      {
        ...
        clue: 'Scannez la méduse lumineuse.',
        latitude: 47.2078,
        longitude: -1.5641,
        radius: 50,
        actionType: 'QR_CODE',
      ...
      },
      {
        ...
        clue: "Résolvez l'énigme du puits central.",
        latitude: 47.216,
        longitude: -1.5497,
        radius: 60,
        actionType: 'RIDDLE',
  ...
  console.log(
    '✅ Seed terminé — 10 chasses, 5 utilisateurs, participations créées',
  );
}
