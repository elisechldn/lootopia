    ...
    <div className="flex flex-col h-screen pb-tabbar">
      ...
      <div className="flex flex-col flex-1 pt-topbar overflow-hidden">
        ...
        <div className="px-4 py-2 border-b border-border flex items-center justify-between">
          ...
          {status === "geoerror" && <span className="text-xs text-muted-foreground">Géolocalisation indisponible</span>}
        </div>
        ...
        {status === "loading" ? (
          ...
          <HuntMap hunts={hunts} center={coords ?? { lat: 48.8566, lon: 2.3522 }} />
        )}
      </div>
      <TabNavigation />
    </div>
