            ...
            <div className="flex items-center gap-1 shrink-0">
                {onSearchClick && (
                  <button
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-full text-foreground bg-transparent border-0 cursor-pointer transition-[background] duration-150 hover:bg-gray-500/10"
                  >
                    <Search size={20} />
                  </button>
                )}
