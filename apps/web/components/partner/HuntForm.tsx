            ...
            <div className="mb-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => handleSave("FINISHED")} disabled={saving}
                            className="px-4 py-2 text-sm font-medium text-white bg-gray-600 rounded-lg hover:bg-gray-500 transition-colors disabled:opacity-50">
                        Mettre en pause
                    </button>
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea value={form.fullDescription}
                                          ...
                                          rows={5}
                                          className="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 resize-none" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div
                                ...
                                className="h-64 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center gap-3 cursor-pointer hover:bg-gray-50 transition-colors overflow-hidden"
                            >
                                {coverImage ? (
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                            {tags.map((tag) => (
                                <span key={tag}
                                      className="inline-flex items-center gap-1.5 px-3 py-1 text-sm border border-gray-300 rounded-full text-gray-600">
                                    {tag}
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs text-gray-500 mb-1">Type de récompense</label>
                            ...
                            <div>
                                <label className="block text-xs text-gray-500 mb-1">Valeur de la récompense</label>
